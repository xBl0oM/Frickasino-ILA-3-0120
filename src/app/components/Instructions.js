...
const Instructions = () => {
  ...
  // Funktion zum Rendern der Spielanleitungen basierend auf dem ausgewählten Spiel
        ...
        return (
          <div className="text-center">
            ...
            <div className="flex flex-col items-center gap-4">
              <Link
                to="/instructions/roulette"
                className="bg-blue-600 hover:bg-blue-700 text-xl py-3 px-6 rounded-full shadow-lg mb-2"
              >
                Roulette
              </Link>
              <Link
                to="/instructions/baccarat"
                className="bg-blue-600 hover:bg-blue-700 text-xl py-3 px-6 rounded-full shadow-lg mb-2"
              >
                Baccara
              </Link>
              <Link
                to="/instructions/blackjack"
                className="bg-blue-600 hover:bg-blue-700 text-xl py-3 px-6 rounded-full shadow-lg mb-2"
              >
                Blackjack
              </Link>
              <Link
                to="/instructions/slots"
                className="bg-blue-600 hover:bg-blue-700 text-xl py-3 px-6 rounded-full shadow-lg mb-2"
              >
                Slots
              </Link>
  ...
  return (
    <div className="bg-gradient-to-r from-blue-400 via-green-400 to-pink-400 min-h-screen text-white py-12">
      {renderInstructions()}
    </div>
  );
};
